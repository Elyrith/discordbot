...
class DiscordBot(commands.AutoShardedBot):
	...
	def __init__(self):
		...
		self.client_id: str = config.discordbot_clientid
	...
	async def on_ready(self):
		if not hasattr(self, 'uptime'):
			...
			await self.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="for commands"))
